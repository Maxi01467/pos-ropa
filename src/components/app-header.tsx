        ...
        <header className="sticky top-0 z-30 border-b border-white/20 bg-white/40 dark:bg-black/20 dark:border-white/10 backdrop-blur-xl">
            <div className="flex min-h-[76px] items-center gap-4 px-4 py-3 sm:px-5 lg:px-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {/* Bell with orange gradient like v0 */}
                    <button
                        className="hidden size-10 items-center justify-center rounded-2xl border border-border/60 bg-card/78 lg:flex"
                        type="button"
                    ...
                    <button
                        ...
                        className="relative flex size-10 items-center justify-center rounded-2xl border border-border/60 bg-card/78 transition-colors hover:bg-muted"
                    >
