...
function MetricCard({
    ...
    return (
        <Card className="rounded-[1.25rem] border border-border/40 bg-card shadow-sm dark:bg-slate-900">
            <CardContent className="p-4">
                <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                        ...
                        <p className={cn("mt-2 text-2xl font-semibold tracking-[-0.04em]", valueClassName)}>
                            {value}
                        </p>
                        {description ? (
                    ...
                    <div className={cn("rounded-xl p-2.5", iconClassName)}>{icon}</div>
                </div>
            </CardContent>
        </Card>
    );
...
function AbrirCajaView({
    ...
    return (
        <div className="flex flex-col items-center justify-start bg-slate-50/50 p-2 dark:bg-slate-950/20 sm:p-3">
            <Card className="w-full max-w-md rounded-[1.75rem] border-border/40 p-5 shadow-md sm:p-6">
                <CardContent className="p-0">
                    <div className="flex flex-col items-center text-center">
                        <div className="mb-3 rounded-full bg-amber-500/10 p-3.5 text-amber-600 animate-pulse dark:text-amber-400">
                        ...
                        <p className="mt-2 text-sm leading-6 text-muted-foreground">
                            Las operaciones están bloqueadas. Ingresá los datos para habilitar el turno.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <Button
                            className="mt-5 h-12 w-full rounded-xl text-base shadow-sm transition-all"
                            onClick={onOpen}
                        >
            ...
            <div className="animate-in fade-in duration-300">
                <div className="flex w-full flex-col gap-5">
                    <ShellHeader
                        ...
                        tone="success"
                        aside={
                            <div className="rounded-[1.25rem] border border-border/40 bg-white/80 p-4 shadow-sm dark:bg-slate-900/75">
                                <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-emerald-800/80 dark:text-emerald-100/80">
                                    Apertura
                                </p>
                                <p className="mt-2 text-base font-semibold text-foreground">
                                ...
                                <div className="mt-4 rounded-2xl border border-border/40 bg-card p-3 dark:bg-slate-950/40">
                    ...
                    <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1fr_380px]">
                        <div className="min-w-0 space-y-5">
                            ...
                            <Card className="rounded-[1.5rem] border border-border/40 bg-card shadow-sm dark:bg-slate-900">
                                    ...
                                    {session.movements.length === 0 ? (
                                        ...
                                        <div className="space-y-3">
                                            {paginatedMovements.map((mov) => (
                                                <div
                                                    key={mov.id}
                                                    className="flex items-center justify-between rounded-2xl border border-border/40 bg-white p-4 shadow-sm dark:bg-slate-950/40"
                                                >
                                            ...
                                            <div className="flex flex-col gap-3 rounded-[1.25rem] border border-border/40 bg-white px-4 py-3 shadow-sm sm:flex-row sm:items-center sm:justify-between dark:bg-slate-950/40">
                        ...
                        <Card className="h-fit rounded-[1.5rem] border border-border/40 bg-card shadow-sm xl:sticky xl:top-6 dark:bg-slate-900">
                            <CardHeader>
                            ...
                            <CardContent className="space-y-4">
                                <div className="rounded-xl border border-border/40 bg-white p-4 shadow-sm dark:bg-slate-950/40">
            ...
            <Dialog open={movementDialogOpen} onOpenChange={setMovementDialogOpen}>
                <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                        <div className="grid grid-cols-2 gap-2 rounded-2xl border border-border/40 bg-muted/35 p-1">
                            <Button
                                type="button"
                                variant={movementType === "EGRESO" ? "default" : "ghost"}
                                className={cn(
                            ...
                            <Button
                                type="button"
                                variant={movementType === "INGRESO" ? "default" : "ghost"}
                                className={cn(
                                    "h-10 gap-2 rounded-xl",
            ...
            <Dialog open={closeDialogOpen} onOpenChange={setCloseDialogOpen}>
                <DialogContent>
                    ...
                    <div className="space-y-6 py-4">
                        <div className="flex items-center justify-between rounded-lg border border-border/40 bg-card p-4 shadow-sm dark:bg-slate-900">
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-center">
                            ...
                            Podés hacer el arqueo después desde la pestaña{" "}
